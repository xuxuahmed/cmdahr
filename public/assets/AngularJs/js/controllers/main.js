materialAdmin
    ...
    .controller('profileCtrl', function(growlService){
        ...
        //User
        this.profileSummary = " leo.";
    
        this.fullName = "Azma";
        this.gender = "female";
        this.birthDay = "23/06/1988";
        this.martialStatus = "7704259889101";
        this.mobileNumber = "7655055";
        this.emailAddress = "azma@gmail.com";
        this.addressSuite = "M. Sunrise Aage";
        this.addressCity = "Male'";
        this.addressCountry = "Maldives";
