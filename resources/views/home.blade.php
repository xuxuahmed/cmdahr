...
<!--[if IE 9 ]><html class="ie9"><![endif]-->
    <head>
        ...
        <!-- Vendor CSS -->
        <link href="assets/jquery/vendors/bower_components/fullcalendar/dist/fullcalendar.min.css" rel="stylesheet">
        <link href="assets/jquery/vendors/bower_components/animate.css/animate.min.css" rel="stylesheet">
        <link href="assets/jquery/vendors/bower_components/sweetalert/dist/sweetalert.css" rel="stylesheet">
        <link href="assets/jquery/vendors/bower_components/material-design-iconic-font/dist/css/material-design-iconic-font.min.css" rel="stylesheet">
        <link href="assets/jquery/vendors/bower_components/malihu-custom-scrollbar-plugin/jquery.mCustomScrollbar.min.css" rel="stylesheet">

        <!-- CSS -->
        <link href="assets/jquery/css/app_1.min.css" rel="stylesheet">
        <link href="assets/jquery/css/app_2.min.css" rel="stylesheet">
    ...
    <body>
                        ...
                        <li class="dropdown">
                            ...
                            <div class="dropdown-menu dropdown-menu-lg pull-right">
                                <div class="list-group list-group-light">
                                    ...
                                    <a class="view-more view-more-light" href="">View All</a>
                                </div>
                            </div>
                        </li>
                        <li class="dropdown">
                ...
                <ul class="main-menu">
                    <li class="mm-profile sub-menu">
                        <a href="" data-ma-action="submenu-toggle" class="media">
                            <img class="pull-left" src="img/profile-pics/1.jpg" alt="">
                            <div class="media-body">
                                Malinda Hollaway
                                <small>malinda-h@gmail.com</small>
                            </div>
                        </a>

                        <ul>
                            <li>
                                <a href="profile-about.html">View Profile</a>
                            </li>
                            <li>
                    ...
                    <li class="sub-menu">
                        ...
                        <ul>
                            ...
                            <li><a href="form-validations.html">One more</a></li>
                        </ul>
                    </li>
                    <li>
                        ...
                        <div class="col-sm-6">
                            ...
                            <div class="card" id="calendar-widget">
                                <div class="card-header ch-alt">
                                    ...
                                    <button class="btn btn-default bg btn-float"><i class="zmdi zmdi-plus"></i></button>
                                </div>
                            ...
                            <div class="card">
                                <div class="card-header ch-alt m-b-20">
                                    ...
                                    <button class="btn btn-default btn-float"><i class="zmdi zmdi-plus"></i></button>
                                </div>
        ...
        <script src="assets/jquery/vendors/bower_components/jquery/dist/jquery.min.js"></script>
        <script src="assets/jquery/vendors/bower_components/bootstrap/dist/js/bootstrap.min.js"></script>

        <script src="assets/jquery/vendors/bower_components/flot/jquery.flot.js"></script>
        <script src="assets/jquery/vendors/bower_components/flot/jquery.flot.resize.js"></script>
        <script src="assets/jquery/vendors/bower_components/flot.curvedlines/curvedLines.js"></script>
        <script src="assets/jquery/vendors/sparklines/jquery.sparkline.min.js"></script>
        <script src="assets/jquery/vendors/bower_components/jquery.easy-pie-chart/dist/jquery.easypiechart.min.js"></script>

        <script src="assets/jquery/vendors/bower_components/moment/min/moment.min.js"></script>
        <script src="assets/jquery/vendors/bower_components/fullcalendar/dist/fullcalendar.min.js "></script>
        <script src="assets/jquery/vendors/bower_components/simpleWeather/jquery.simpleWeather.min.js"></script>
        <script src="assets/jquery/vendors/bower_components/Waves/dist/waves.min.js"></script>
        <script src="assets/jquery/vendors/bootstrap-growl/bootstrap-growl.min.js"></script>
        <script src="assets/jquery/vendors/bower_components/sweetalert/dist/sweetalert.min.js"></script>
        <script src="assets/jquery/vendors/bower_components/malihu-custom-scrollbar-plugin/jquery.mCustomScrollbar.concat.min.js"></script>
        ...
        <script src="assets/jquery/js/app.min.js"></script>
    </body>
  </html>
